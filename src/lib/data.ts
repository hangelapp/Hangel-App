...
export const marketBrands: Brand[] = [
    ...
    { id: '5', name: 'Sportive', category: 'Spor Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    { id: '6', name: 'FashFed', category: 'Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 150000, type: 'brand' },
    { id: '7', name: 'Skechers', category: 'Ayakkabı', donationRate: 6, logoUrl: '', link: '#', followers: 2500000, type: 'brand' },
    { id: '8', name: 'MarkaStok', category: 'Giyim', donationRate: 15, logoUrl: '', link: '#', followers: 80000, type: 'brand' },
    { id: '9', name: 'Fashfed Mobile', category: 'Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 100000, type: 'brand' },
    { id: '10', name: 'Playsports', category: 'Spor Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 40000, type: 'brand' },
    { id: '11', name: 'Columbİa', category: 'Outdoor', donationRate: 7, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '12', name: 'Converse', category: 'Ayakkabı', donationRate: 5, logoUrl: '', link: '#', followers: 5000000, type: 'brand' },
    { id: '13', name: 'Hotiç', category: 'Ayakkabı', donationRate: 9, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '14', name: 'SuperStep', category: 'Ayakkabı', donationRate: 10, logoUrl: '', link: '#', followers: 1500000, type: 'brand' },
    { id: '15', name: 'Houseofsuperstep', category: 'Ayakkabı', donationRate: 10, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '16', name: 'PUMA', category: 'Spor Giyim', donationRate: 6, logoUrl: '', link: '#', followers: 10000000, type: 'brand' },
    { id: '17', name: 'Sporthink', category: 'Spor Giyim', donationRate: 11, logoUrl: '', link: '#', followers: 70000, type: 'brand' },
    { id: '18', name: 'FLO', category: 'Ayakkabı', donationRate: 4, logoUrl: '', link: '#', followers: 3000000, type: 'brand' },
    { id: '19', name: 'Intersport', category: 'Spor Giyim', donationRate: 5, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    { id: '20', name: 'The Moose Bay', category: 'Outdoor', donationRate: 12, logoUrl: '', link: '#', followers: 90000, type: 'brand' },
    { id: '21', name: 'Sporpark', category: 'Spor Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 60000, type: 'brand' },
    
    // Kozmetik & Kişisel Bakım
    { id: '22', name: 'Gratis', category: 'Kozmetik', donationRate: 5, logoUrl: '', link: '#', followers: 4000000, type: 'brand' },
    { id: '23', name: 'Lona Cosmetics', category: 'Kozmetik', donationRate: 15, logoUrl: '', link: '#', followers: 50000, type: 'brand' },
    { id: '24', name: 'Arkopharma', category: 'Sağlık', donationRate: 10, logoUrl: '', link: '#', followers: 30000, type: 'brand' },
    { id: '25', name: 'Flormar', category: 'Kozmetik', donationRate: 8, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    { id: '26', name: 'Cosmed', category: 'Kişisel Bakım', donationRate: 12, logoUrl: '', link: '#', followers: 150000, type: 'brand' },
    { id: '27', name: 'Supplementler', category: 'Sağlık', donationRate: 10, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '28', name: 'Vitaminler', category: 'Sağlık', donationRate: 10, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    ...
    { id: '31', name: 'Kuaförümden.com', category: 'Kişisel Bakım', donationRate: 11, logoUrl: '', link: '#', followers: 60000, type: 'brand' },

    // Tatil & Seyahat
    { id: '32', name: 'Tatilbudur', category: 'Seyahat', donationRate: 3, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '33', name: 'Etstur', category: 'Seyahat', donationRate: 2, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    { id: '34', name: 'Touristica', category: 'Seyahat', donationRate: 3, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '35', name: 'SETUR', category: 'Seyahat', donationRate: 2, logoUrl: '', link: '#', followers: 1500000, type: 'brand' },
    { id: '36', name: 'miniyol.com', category: 'Araç Kiralama', donationRate: 5, logoUrl: '', link: '#', followers: 100000, type: 'brand' },
    { id: '37', name: 'Ucuzabilet', category: 'Bilet', donationRate: 1, logoUrl: '', link: '#', followers: 1200000, type: 'brand' },
    { id: '38', name: 'Tatildekirala.com', category: 'Konaklama', donationRate: 4, logoUrl: '', link: '#', followers: 80000, type: 'brand' },
    { id: '39', name: 'bilet.com', category: 'Bilet', donationRate: 1, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    { id: '40', name: 'Samsonite', category: 'Aksesuar', donationRate: 6, logoUrl: '', link: '#', followers: 700000, type: 'brand' },

    // Giyim & Aksesuar
    { id: '41', name: 'Beymen', category: 'Lüks Giyim', donationRate: 4, logoUrl: '', link: '#', followers: 2500000, type: 'brand' },
    { id: '42', name: 'Suwen', category: 'İç Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '43', name: 'Aker', category: 'Tesettür Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '44', name: 'Mizalle', category: 'Tesettür Giyim', donationRate: 12, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    { id: '45', name: 'İpekyol', category: 'Kadın Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 1800000, type: 'brand' },
    { id: '46', name: 'Twist', category: 'Kadın Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 1200000, type: 'brand' },
    { id: '47', name: 'Slazenger', category: 'Spor Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 600000, type: 'brand' },
    { id: '48', name: 'Koton', category: 'Giyim', donationRate: 5, logoUrl: '', link: '#', followers: 5000000, type: 'brand' },
    { id: '49', name: 'H&M', category: 'Giyim', donationRate: 4, logoUrl: '', link: '#', followers: 15000000, type: 'brand' },
    { id: '50', name: 'Machka', category: 'Kadın Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '51', name: 'Fitmoda', category: 'Spor Giyim', donationRate: 13, logoUrl: '', link: '#', followers: 250000, type: 'brand' },
    { id: '52', name: 'Boyner', category: 'Çok Kategorili', donationRate: 3, logoUrl: '', link: '#', followers: 3000000, type: 'brand' },
    { id: '53', name: 'Dagi', category: 'İç Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 350000, type: 'brand' },
    { id: '54', name: 'Addax.com.tr', category: 'Kadın Giyim', donationRate: 11, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '55', name: 'Marks & Spencer', category: 'Giyim', donationRate: 6, logoUrl: '', link: '#', followers: 1300000, type: 'brand' },
    { id: '56', name: 'GAP', category: 'Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    { id: '57', name: 'Mango', category: 'Giyim', donationRate: 5, logoUrl: '', link: '#', followers: 8000000, type: 'brand' },
    { id: '58', name: 'Divarese', category: 'Ayakkabı', donationRate: 8, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '59', name: 'LTB', category: 'Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 1500000, type: 'brand' },
    { id: '60', name: 'Benetton', category: 'Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    ...
    { id: '63', name: 'Colins', category: 'Giyim', donationRate: 6, logoUrl: '', link: '#', followers: 2200000, type: 'brand' },
    { id: '64', name: 'NetWork', category: 'Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 1100000, type: 'brand' },
    { id: '65', name: 'Kip', category: 'Erkek Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    { id: '66', name: 'Livi.com', category: 'Giyim', donationRate: 10, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '67', name: 'DS Damat', category: 'Erkek Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    { id: '68', name: 'Hemington', category: 'Erkek Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '69', name: 'Altınyıldız', category: 'Erkek Giyim', donationRate: 6, logoUrl: '', link: '#', followers: 1300000, type: 'brand' },
    { id: '70', name: 'Yargıcı', category: 'Kadın Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 700000, type: 'brand' },
    { id: '71', name: 'Nautica', category: 'Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 600000, type: 'brand' },
    { id: '72', name: 'Wrangler', category: 'Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '73', name: 'Gant', category: 'Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '74', name: 'Pierre Cardin', category: 'Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 1200000, type: 'brand' },
    { id: '75', name: 'Avva', category: 'Erkek Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    { id: '76', name: 'Ramsey', category: 'Erkek Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '77', name: 'Kayra', category: 'Tesettür Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 600000, type: 'brand' },
    { id: '78', name: 'Black Spade', category: 'İç Giyim', donationRate: 11, logoUrl: '', link: '#', followers: 150000, type: 'brand' },
    { id: '79', name: 'SPX', category: 'Outdoor', donationRate: 8, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '80', name: 'Cacharel', category: 'Erkek Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    { id: '81', name: 'Scooter', category: 'Ayakkabı', donationRate: 10, logoUrl: '', link: '#', followers: 250000, type: 'brand' },
    { id: '82', name: 'Tudors', category: 'Erkek Giyim', donationRate: 9, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '83', name: 'Lacoste', category: 'Giyim', donationRate: 6, logoUrl: '', link: '#', followers: 3000000, type: 'brand' },
    { id: '84', name: 'US Polo', category: 'Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    
    // Bebek & Çocuk
    { id: '85', name: 'Carter’s', category: 'Bebek Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '86', name: 'E-bebek', category: 'Bebek Ürünleri', donationRate: 4, logoUrl: '', link: '#', followers: 3000000, type: 'brand' },
    { id: '87', name: 'Jacadi', category: 'Çocuk Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '88', name: 'Miniyol', category: 'Araç Kiralama', donationRate: 5, logoUrl: '', link: '#', followers: 100000, type: 'brand' },
    { id: '89', name: 'Toyzz Shop', category: 'Oyuncak', donationRate: 6, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },

    // Ev & Yaşam
    { id: '90', name: 'Doğtaş Home', category: 'Mobilya', donationRate: 5, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    { id: '91', name: 'Kelebek Mobilya', category: 'Mobilya', donationRate: 5, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '92', name: 'Koçtaş', category: 'Yapı Market', donationRate: 3, logoUrl: '', link: '#', followers: 2500000, type: 'brand' },
    { id: '93', name: 'Karaca', category: 'Mutfak', donationRate: 7, logoUrl: '', link: '#', followers: 4000000, type: 'brand' },
    { id: '94', name: 'Bella Maison', category: 'Ev Tekstili', donationRate: 10, logoUrl: '', link: '#', followers: 600000, type: 'brand' },
    { id: '95', name: 'Mobeseavm', category: 'Mobilya', donationRate: 8, logoUrl: '', link: '#', followers: 100000, type: 'brand' },
    { id: '96', name: 'Homend', category: 'Küçük Ev Aletleri', donationRate: 9, logoUrl: '', link: '#', followers: 300000, type: 'brand' },
    { id: '97', name: 'Yatsan', category: 'Yatak', donationRate: 6, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '98', name: 'Arçelik', category: 'Beyaz Eşya', donationRate: 2, logoUrl: '', link: '#', followers: 3000000, type: 'brand' },
    { id: '99', name: 'Mudo', category: 'Ev & Giyim', donationRate: 7, logoUrl: '', link: '#', followers: 1500000, type: 'brand' },
    { id: '100', name: 'Hisar', category: 'Mutfak', donationRate: 9, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '101', name: 'Beko', category: 'Beyaz Eşya', donationRate: 2, logoUrl: '', link: '#', followers: 2800000, type: 'brand' },
    { id: '102', name: 'Fakir', category: 'Küçük Ev Aletleri', donationRate: 8, logoUrl: '', link: '#', followers: 700000, type: 'brand' },
    { id: '103', name: 'Korkmazstore.com.tr', category: 'Mutfak', donationRate: 10, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '104', name: 'Taç', category: 'Ev Tekstili', donationRate: 9, logoUrl: '', link: '#', followers: 1200000, type: 'brand' },
    { id: '105', name: 'Linens', category: 'Ev Tekstili', donationRate: 8, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '106', name: 'Kütahya Porselen', category: 'Mutfak', donationRate: 9, logoUrl: '', link: '#', followers: 600000, type: 'brand' },

    // Pazaryeri & Market
    { id: '107', name: 'A101', category: 'Market', donationRate: 1, logoUrl: '', link: '#', followers: 5000000, type: 'brand' },
    { id: '108', name: 'Getir', category: 'Hızlı Market', donationRate: 1, logoUrl: '', link: '#', followers: 8000000, type: 'brand' },
    { id: '109', name: 'CarrefourSA', category: 'Market', donationRate: 1, logoUrl: '', link: '#', followers: 4000000, type: 'brand' },
    { id: '110', name: 'Letgo', category: 'Pazaryeri', donationRate: 2, logoUrl: '', link: '#', followers: 10000000, type: 'brand' },
    { id: '111', name: 'Pazarama', category: 'Pazaryeri', donationRate: 2, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '112', name: 'n11', category: 'Pazaryeri', donationRate: 1.5, logoUrl: '', link: '#', followers: 12000000, type: 'brand' },
    { id: '113', name: 'Occasion', category: 'Giyim Pazaryeri', donationRate: 10, logoUrl: '', link: '#', followers: 300000, type: 'brand' },

    // Elektronik
    { id: '114', name: 'Samsung', category: 'Elektronik', donationRate: 1.5, logoUrl: '', link: '#', followers: 20000000, type: 'brand' },
    { id: '115', name: 'Xiaomi', category: 'Elektronik', donationRate: 2, logoUrl: '', link: '#', followers: 15000000, type: 'brand' },
    { id: '116', name: 'General Mobile', category: 'Elektronik', donationRate: 4, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '117', name: 'Casper', category: 'Elektronik', donationRate: 3, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '118', name: 'MediaMarkt', category: 'Elektronik', donationRate: 1, logoUrl: '', link: '#', followers: 4000000, type: 'brand' },
    { id: '119', name: 'Anker', category: 'Aksesuar', donationRate: 8, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '120', name: 'Doremusic', category: 'Müzik Aletleri', donationRate: 7, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '121', name: 'Natro Hosting', category: 'Teknoloji', donationRate: 15, logoUrl: '', link: '#', followers: 150000, type: 'brand' },
    { id: '122', name: 'Teknosa', category: 'Elektronik', donationRate: 1, logoUrl: '', link: '#', followers: 3500000, type: 'brand' },
    { id: '123', name: 'Huawei', category: 'Elektronik', donationRate: 2, logoUrl: '', link: '#', followers: 10000000, type: 'brand' },

    // Yeme & İçme & Gurme
    { id: '124', name: 'Tchibo', category: 'Kahve & Giyim', donationRate: 8, logoUrl: '', link: '#', followers: 1000000, type: 'brand' },
    { id: '125', name: 'Bialetti Kahve', category: 'Kahve', donationRate: 10, logoUrl: '', link: '#', followers: 150000, type: 'brand' },
    { id: '126', name: 'Little Caesars', category: 'Restoran', donationRate: 4, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '127', name: 'Mamaplus', category: 'Evcil Hayvan', donationRate: 12, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '128', name: 'Oleamea', category: 'Gurme', donationRate: 15, logoUrl: '', link: '#', followers: 50000, type: 'brand' },
    { id: '129', name: 'Fellas', category: 'Sağlıklı Gıda', donationRate: 13, logoUrl: '', link: '#', followers: 300000, type: 'brand' },

    // Mücevher & Saat
    { id: '130', name: 'Altınbaş', category: 'Mücevher', donationRate: 5, logoUrl: '', link: '#', followers: 900000, type: 'brand' },
    { id: '131', name: 'Saat&Saat', category: 'Saat', donationRate: 6, logoUrl: '', link: '#', followers: 1100000, type: 'brand' },
    { id: '132', name: 'Lizay Pırlanta', category: 'Mücevher', donationRate: 8, logoUrl: '', link: '#', followers: 400000, type: 'brand' },
    { id: '133', name: 'Konyalı Saat', category: 'Saat', donationRate: 7, logoUrl: '', link: '#', followers: 500000, type: 'brand' },
    { id: '134', name: 'Zwilling', category: 'Mutfak', donationRate: 9, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    { id: '135', name: 'Hizlisaat.com', category: 'Saat', donationRate: 10, logoUrl: '', link: '#', followers: 150000, type: 'brand' },

    // Hobi & Hediye & Diğer
    { id: '136', name: 'Idefix', category: 'Kitap', donationRate: 5, logoUrl: '', link: '#', followers: 700000, type: 'brand' },
    { id: '137', name: 'D&R', category: 'Kitap & Hobi', donationRate: 4, logoUrl: '', link: '#', followers: 2000000, type: 'brand' },
    { id: '138', name: 'Vidyodan', category: 'Eğitim', donationRate: 20, logoUrl: '', link: '#', followers: 30000, type: 'brand' },
    { id: '139', name: 'Sosyopix', category: 'Hediye', donationRate: 12, logoUrl: '', link: '#', followers: 800000, type: 'brand' },
    { id: '140', name: 'Tazecicek', category: 'Hediye', donationRate: 10, logoUrl: '', link: '#', followers: 600000, type: 'brand' },
    { id: '141', name: 'Bloom and Fresh', category: 'Hediye', donationRate: 15, logoUrl: '', link: '#', followers: 200000, type: 'brand' },
    ...
    { id: '144', name: 'Tonguç Akademi', category: 'Eğitim', donationRate: 9, logoUrl: '', link: '#', followers: 1500000, type: 'brand' },
    { id: '145', name: 'Petzzshop', category: 'Evcil Hayvan', donationRate: 10, logoUrl: '', link: '#', followers: 300000, type: 'brand' },

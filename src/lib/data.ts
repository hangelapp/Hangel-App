...
export const managedItems: ManagedItem[] = [
    ...
    { name: 'İTÜ Girişimcilik Kulübü', type: 'Öğrenci Kulübü', icon: 'users', href: '/admin/clubs/profile/1', status: 'approved', logoUrl: 'https://logo.clearbit.com/itu.edu.tr' },
    { name: 'Mavi', type: 'Marka', icon: 'store', href: '/market/mavi', status: 'approved', logoUrl: 'https://logo.clearbit.com/mavi.com' },
];

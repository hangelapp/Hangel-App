...
export const marketBrands: Brand[] = [
    ...
    { id: '15', name: 'Houseofsuperstep', category: 'Ayakkabı', donationRate: 10, logoUrl: 'https://logo.clearbit.com/superstep.com.tr', link: '#', followers: 200000, type: 'brand' },
    { id: '16', name: 'PUMA', category: 'Spor Giyim', donationRate: 6, logoUrl: 'https://logo.clearbit.com/puma.com', link: '#', followers: 10000000, type: 'brand' },
    { id: '17', name: 'Sporthink', category: 'Spor Giyim', donationRate: 11, logoUrl: 'https://logo.clearbit.com/sporthink.com.tr', link: '#', followers: 70000, type: 'brand' },
    { id: '18', name: 'FLO', category: 'Ayakkabı', donationRate: 4, logoUrl: 'https://logo.clearbit.com/flo.com.tr', link: '#', followers: 3000000, type: 'brand' },
    { id: '19', name: 'Intersport', category: 'Spor Giyim', donationRate: 5, logoUrl: 'https://logo.clearbit.com/intersport.com.tr', link: '#', followers: 2000000, type: 'brand' },
    { id: '20', name: 'The Moose Bay', category: 'Outdoor', donationRate: 12, logoUrl: 'https://logo.clearbit.com/themoosebay.com', link: '#', followers: 90000, type: 'brand' },
    { id: '21', name: 'Sporpark', category: 'Spor Giyim', donationRate: 10, logoUrl: 'https://logo.clearbit.com/sporpark.com.tr', link: '#', followers: 60000, type: 'brand' },
    
    // Kozmetik & Kişisel Bakım
    { id: '22', name: 'Gratis', category: 'Kozmetik', donationRate: 5, logoUrl: 'https://logo.clearbit.com/gratis.com', link: '#', followers: 4000000, type: 'brand' },
    { id: '23', name: 'Lona Cosmetics', category: 'Kozmetik', donationRate: 15, logoUrl: '', link: '#', followers: 50000, type: 'brand' },
    { id: '24', name: 'Arkopharma', category: 'Sağlık', donationRate: 10, logoUrl: 'https://logo.clearbit.com/arkopharma.com', link: '#', followers: 30000, type: 'brand' },
    { id: '25', name: 'Flormar', category: 'Kozmetik', donationRate: 8, logoUrl: 'https://logo.clearbit.com/flormar.com.tr', link: '#', followers: 2000000, type: 'brand' },
    { id: '26', name: 'Cosmed', category: 'Kişisel Bakım', donationRate: 12, logoUrl: 'https://logo.clearbit.com/cosmed.com.tr', link: '#', followers: 150000, type: 'brand' },
    { id: '27', name: 'Supplementler', category: 'Sağlık', donationRate: 10, logoUrl: 'https://logo.clearbit.com/supplementler.com', link: '#', followers: 500000, type: 'brand' },
    { id: '28', name: 'Vitaminler', category: 'Sağlık', donationRate: 10, logoUrl: 'https://logo.clearbit.com/vitaminler.com', link: '#', followers: 300000, type: 'brand' },
    { id: '29', name: 'CocoBody', category: 'Kişisel Bakım', donationRate: 18, logoUrl: '', link: '#', followers: 40000, type: 'brand' },
    { id: '30', name: 'Recete', category: 'Sağlık', donationRate: 9, logoUrl: '', link: '#', followers: 20000, type: 'brand' },
    { id: '31', name: 'Kuaförümden.com', category: 'Kişisel Bakım', donationRate: 11, logoUrl: 'https://logo.clearbit.com/kuaforumden.com', link: '#', followers: 60000, type: 'brand' },

    // Tatil & Seyahat
    { id: '32', name: 'Tatilbudur', category: 'Seyahat', donationRate: 3, logoUrl: 'https://logo.clearbit.com/tatilbudur.com', link: '#', followers: 1000000, type: 'brand' },
    { id: '33', name: 'Etstur', category: 'Seyahat', donationRate: 2, logoUrl: 'https://logo.clearbit.com/etstur.com', link: '#', followers: 2000000, type: 'brand' },
    { id: '34', name: 'Touristica', category: 'Seyahat', donationRate: 3, logoUrl: 'https://logo.clearbit.com/touristica.com.tr', link: '#', followers: 500000, type: 'brand' },
    { id: '35', name: 'SETUR', category: 'Seyahat', donationRate: 2, logoUrl: 'https://logo.clearbit.com/setur.com.tr', link: '#', followers: 1500000, type: 'brand' },
    { id: '36', name: 'miniyol.com', category: 'Araç Kiralama', donationRate: 5, logoUrl: 'https://logo.clearbit.com/miniyol.com', link: '#', followers: 100000, type: 'brand' },
    { id: '37', name: 'Ucuzabilet', category: 'Bilet', donationRate: 1, logoUrl: 'https://logo.clearbit.com/ucuzabilet.com', link: '#', followers: 1200000, type: 'brand' },
    { id: '38', name: 'Tatildekirala.com', category: 'Konaklama', donationRate: 4, logoUrl: 'https://logo.clearbit.com/tatildekirala.com', link: '#', followers: 80000, type: 'brand' },
    { id: '39', name: 'bilet.com', category: 'Bilet', donationRate: 1, logoUrl: 'https://logo.clearbit.com/bilet.com', link: '#', followers: 900000, type: 'brand' },
    { id: '40', name: 'Samsonite', category: 'Aksesuar', donationRate: 6, logoUrl: 'https://logo.clearbit.com/samsonite.com.tr', link: '#', followers: 700000, type: 'brand' },

    // Giyim & Aksesuar
    { id: '41', name: 'Beymen', category: 'Lüks Giyim', donationRate: 4, logoUrl: 'https://logo.clearbit.com/beymen.com', link: '#', followers: 2500000, type: 'brand' },
    { id: '42', name: 'Suwen', category: 'İç Giyim', donationRate: 10, logoUrl: 'https://logo.clearbit.com/suwen.com.tr', link: '#', followers: 400000, type: 'brand' },
    { id: '43', name: 'Aker', category: 'Tesettür Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/aker.com.tr', link: '#', followers: 1000000, type: 'brand' },
    { id: '44', name: 'Mizalle', category: 'Tesettür Giyim', donationRate: 12, logoUrl: 'https://logo.clearbit.com/mizalle.com', link: '#', followers: 300000, type: 'brand' },
    { id: '45', name: 'İpekyol', category: 'Kadın Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/ipekyol.com.tr', link: '#', followers: 1800000, type: 'brand' },
    { id: '46', name: 'Twist', category: 'Kadın Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/twist.com.tr', link: '#', followers: 1200000, type: 'brand' },
    { id: '47', name: 'Slazenger', category: 'Spor Giyim', donationRate: 10, logoUrl: 'https://logo.clearbit.com/slazenger.com.tr', link: '#', followers: 600000, type: 'brand' },
    { id: '48', name: 'Koton', category: 'Giyim', donationRate: 5, logoUrl: 'https://logo.clearbit.com/koton.com', link: '#', followers: 5000000, type: 'brand' },
    { id: '49', name: 'H&M', category: 'Giyim', donationRate: 4, logoUrl: 'https://logo.clearbit.com/hm.com', link: '#', followers: 15000000, type: 'brand' },
    { id: '50', name: 'Machka', category: 'Kadın Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/machka.com.tr', link: '#', followers: 500000, type: 'brand' },
    { id: '51', name: 'Fitmoda', category: 'Spor Giyim', donationRate: 13, logoUrl: 'https://logo.clearbit.com/fitmoda.com', link: '#', followers: 250000, type: 'brand' },
    { id: '52', name: 'Boyner', category: 'Çok Kategorili', donationRate: 3, logoUrl: 'https://logo.clearbit.com/boyner.com.tr', link: '#', followers: 3000000, type: 'brand' },
    { id: '53', name: 'Dagi', category: 'İç Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/dagi.com.tr', link: '#', followers: 350000, type: 'brand' },
    { id: '54', name: 'Addax.com.tr', category: 'Kadın Giyim', donationRate: 11, logoUrl: 'https://logo.clearbit.com/addax.com.tr', link: '#', followers: 1000000, type: 'brand' },
    { id: '55', name: 'Marks & Spencer', category: 'Giyim', donationRate: 6, logoUrl: 'https://logo.clearbit.com/marksandspencer.com.tr', link: '#', followers: 1300000, type: 'brand' },
    { id: '56', name: 'GAP', category: 'Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/gap.com.tr', link: '#', followers: 2000000, type: 'brand' },
    { id: '57', name: 'Mango', category: 'Giyim', donationRate: 5, logoUrl: 'https://logo.clearbit.com/mango.com', link: '#', followers: 8000000, type: 'brand' },
    { id: '58', name: 'Divarese', category: 'Ayakkabı', donationRate: 8, logoUrl: 'https://logo.clearbit.com/divarese.com.tr', link: '#', followers: 400000, type: 'brand' },
    { id: '59', name: 'LTB', category: 'Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/ltbjeans.com', link: '#', followers: 1500000, type: 'brand' },
    { id: '60', name: 'Benetton', category: 'Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/benetton.com', link: '#', followers: 900000, type: 'brand' },
    { id: '61', name: 'JeansLab', category: 'Giyim', donationRate: 14, logoUrl: '', link: '#', followers: 120000, type: 'brand' },
    { id: '62', name: 'ElbiseBul', category: 'Kadın Giyim', donationRate: 16, logoUrl: '', link: '#', followers: 80000, type: 'brand' },
    ...
    { id: '70', name: 'Yargıcı', category: 'Kadın Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/yargici.com', link: '#', followers: 700000, type: 'brand' },
    { id: '71', name: 'Nautica', category: 'Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/nautica-tr.com', link: '#', followers: 600000, type: 'brand' },
    { id: '72', name: 'Wrangler', category: 'Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/wrangler.com.tr', link: '#', followers: 500000, type: 'brand' },
    { id: '73', name: 'Gant', category: 'Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/gant.com.tr', link: '#', followers: 800000, type: 'brand' },
    { id: '74', name: 'Pierre Cardin', category: 'Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/pierrecardin.com.tr', link: '#', followers: 1200000, type: 'brand' },
    { id: '75', name: 'Avva', category: 'Erkek Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/avva.com.tr', link: '#', followers: 900000, type: 'brand' },
    { id: '76', name: 'Ramsey', category: 'Erkek Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/ramsey.com.tr', link: '#', followers: 400000, type: 'brand' },
    { id: '77', name: 'Kayra', category: 'Tesettür Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/kayra.com', link: '#', followers: 600000, type: 'brand' },
    { id: '78', name: 'Black Spade', category: 'İç Giyim', donationRate: 11, logoUrl: 'https://logo.clearbit.com/blackspade.com.tr', link: '#', followers: 150000, type: 'brand' },
    { id: '79', name: 'SPX', category: 'Outdoor', donationRate: 8, logoUrl: 'https://logo.clearbit.com/spx.com.tr', link: '#', followers: 400000, type: 'brand' },
    { id: '80', name: 'Cacharel', category: 'Erkek Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/cacharel.com.tr', link: '#', followers: 300000, type: 'brand' },
    { id: '81', name: 'Scooter', category: 'Ayakkabı', donationRate: 10, logoUrl: 'https://logo.clearbit.com/scooter.com.tr', link: '#', followers: 250000, type: 'brand' },
    { id: '82', name: 'Tudors', category: 'Erkek Giyim', donationRate: 9, logoUrl: 'https://logo.clearbit.com/tudors.com', link: '#', followers: 500000, type: 'brand' },
    { id: '83', name: 'Lacoste', category: 'Giyim', donationRate: 6, logoUrl: 'https://logo.clearbit.com/lacoste.com.tr', link: '#', followers: 3000000, type: 'brand' },
    { id: '84', name: 'US Polo', category: 'Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/tr.uspoloassn.com', link: '#', followers: 2000000, type: 'brand' },
    
    // Bebek & Çocuk
    { id: '85', name: 'Carter’s', category: 'Bebek Giyim', donationRate: 8, logoUrl: 'https://logo.clearbit.com/carters.com', link: '#', followers: 500000, type: 'brand' },
    { id: '86', name: 'E-bebek', category: 'Bebek Ürünleri', donationRate: 4, logoUrl: 'https://logo.clearbit.com/e-bebek.com', link: '#', followers: 3000000, type: 'brand' },
    { id: '87', name: 'Jacadi', category: 'Çocuk Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/jacadi.com.tr', link: '#', followers: 200000, type: 'brand' },
    { id: '88', name: 'Miniyol', category: 'Araç Kiralama', donationRate: 5, logoUrl: 'https://logo.clearbit.com/miniyol.com', link: '#', followers: 100000, type: 'brand' },
    { id: '89', name: 'Toyzz Shop', category: 'Oyuncak', donationRate: 6, logoUrl: 'https://logo.clearbit.com/toyzzshop.com', link: '#', followers: 1000000, type: 'brand' },

    // Ev & Yaşam
    { id: '90', name: 'Doğtaş Home', category: 'Mobilya', donationRate: 5, logoUrl: 'https://logo.clearbit.com/dogtas.com', link: '#', followers: 900000, type: 'brand' },
    { id: '91', name: 'Kelebek Mobilya', category: 'Mobilya', donationRate: 5, logoUrl: 'https://logo.clearbit.com/kelebek.com', link: '#', followers: 800000, type: 'brand' },
    { id: '92', name: 'Koçtaş', category: 'Yapı Market', donationRate: 3, logoUrl: 'https://logo.clearbit.com/koctas.com.tr', link: '#', followers: 2500000, type: 'brand' },
    { id: '93', name: 'Karaca', category: 'Mutfak', donationRate: 7, logoUrl: 'https://logo.clearbit.com/karaca.com', link: '#', followers: 4000000, type: 'brand' },
    { id: '94', name: 'Bella Maison', category: 'Ev Tekstili', donationRate: 10, logoUrl: 'https://logo.clearbit.com/bellamaison.com', link: '#', followers: 600000, type: 'brand' },
    { id: '95', name: 'Mobeseavm', category: 'Mobilya', donationRate: 8, logoUrl: '', link: '#', followers: 100000, type: 'brand' },
    { id: '96', name: 'Homend', category: 'Küçük Ev Aletleri', donationRate: 9, logoUrl: 'https://logo.clearbit.com/homend.com.tr', link: '#', followers: 300000, type: 'brand' },
    { id: '97', name: 'Yatsan', category: 'Yatak', donationRate: 6, logoUrl: 'https://logo.clearbit.com/yatsan.com', link: '#', followers: 500000, type: 'brand' },
    { id: '98', name: 'Arçelik', category: 'Beyaz Eşya', donationRate: 2, logoUrl: 'https://logo.clearbit.com/arcelik.com.tr', link: '#', followers: 3000000, type: 'brand' },
    { id: '99', name: 'Mudo', category: 'Ev & Giyim', donationRate: 7, logoUrl: 'https://logo.clearbit.com/mudo.com.tr', link: '#', followers: 1500000, type: 'brand' },
    { id: '100', name: 'Hisar', category: 'Mutfak', donationRate: 9, logoUrl: 'https://logo.clearbit.com/hisar.com.tr', link: '#', followers: 400000, type: 'brand' },
    { id: '101', name: 'Beko', category: 'Beyaz Eşya', donationRate: 2, logoUrl: 'https://logo.clearbit.com/beko.com.tr', link: '#', followers: 2800000, type: 'brand' },
    { id: '102', name: 'Fakir', category: 'Küçük Ev Aletleri', donationRate: 8, logoUrl: 'https://logo.clearbit.com/fakir.com.tr', link: '#', followers: 700000, type: 'brand' },
    { id: '103', name: 'Korkmazstore.com.tr', category: 'Mutfak', donationRate: 10, logoUrl: 'https://logo.clearbit.com/korkmazstore.com.tr', link: '#', followers: 1000000, type: 'brand' },
    { id: '104', name: 'Taç', category: 'Ev Tekstili', donationRate: 9, logoUrl: 'https://logo.clearbit.com/tac.com.tr', link: '#', followers: 1200000, type: 'brand' },
    { id: '105', name: 'Linens', category: 'Ev Tekstili', donationRate: 8, logoUrl: 'https://logo.clearbit.com/linens.com.tr', link: '#', followers: 800000, type: 'brand' },
    { id: '106', name: 'Kütahya Porselen', category: 'Mutfak', donationRate: 9, logoUrl: 'https://logo.clearbit.com/kutahyaporselen.com', link: '#', followers: 600000, type: 'brand' },

    // Pazaryeri & Market
    { id: '107', name: 'A101', category: 'Market', donationRate: 1, logoUrl: 'https://logo.clearbit.com/a101.com.tr', link: '#', followers: 5000000, type: 'brand' },
    { id: '108', name: 'Getir', category: 'Hızlı Market', donationRate: 1, logoUrl: 'https://logo.clearbit.com/getir.com', link: '#', followers: 8000000, type: 'brand' },
    { id: '109', name: 'CarrefourSA', category: 'Market', donationRate: 1, logoUrl: 'https://logo.clearbit.com/carrefoursa.com', link: '#', followers: 4000000, type: 'brand' },
    { id: '110', name: 'Letgo', category: 'Pazaryeri', donationRate: 2, logoUrl: 'https://logo.clearbit.com/letgo.com', link: '#', followers: 10000000, type: 'brand' },
    { id: '111', name: 'Pazarama', category: 'Pazaryeri', donationRate: 2, logoUrl: 'https://logo.clearbit.com/pazarama.com', link: '#', followers: 1000000, type: 'brand' },
    { id: '112', name: 'n11', category: 'Pazaryeri', donationRate: 1.5, logoUrl: 'https://logo.clearbit.com/n11.com', link: '#', followers: 12000000, type: 'brand' },
    { id: '113', name: 'Occasion', category: 'Giyim Pazaryeri', donationRate: 10, logoUrl: '', link: '#', followers: 300000, type: 'brand' },

    // Elektronik
    { id: '114', name: 'Samsung', category: 'Elektronik', donationRate: 1.5, logoUrl: 'https://logo.clearbit.com/samsung.com', link: '#', followers: 20000000, type: 'brand' },
    { id: '115', name: 'Xiaomi', category: 'Elektronik', donationRate: 2, logoUrl: 'https://logo.clearbit.com/mi.com/tr', link: '#', followers: 15000000, type: 'brand' },
    { id: '116', name: 'General Mobile', category: 'Elektronik', donationRate: 4, logoUrl: 'https://logo.clearbit.com/generalmobile.com', link: '#', followers: 500000, type: 'brand' },
    { id: '117', name: 'Casper', category: 'Elektronik', donationRate: 3, logoUrl: 'https://logo.clearbit.com/casper.com.tr', link: '#', followers: 800000, type: 'brand' },
    { id: '118', name: 'MediaMarkt', category: 'Elektronik', donationRate: 1, logoUrl: 'https://logo.clearbit.com/mediamarkt.com.tr', link: '#', followers: 4000000, type: 'brand' },
    { id: '119', name: 'Anker', category: 'Aksesuar', donationRate: 8, logoUrl: 'https://logo.clearbit.com/anker.com.tr', link: '#', followers: 1000000, type: 'brand' },
    { id: '120', name: 'Doremusic', category: 'Müzik Aletleri', donationRate: 7, logoUrl: 'https://logo.clearbit.com/do-re.com.tr', link: '#', followers: 200000, type: 'brand' },
    { id: '121', name: 'Natro Hosting', category: 'Teknoloji', donationRate: 15, logoUrl: 'https://logo.clearbit.com/natro.com', link: '#', followers: 150000, type: 'brand' },
    { id: '122', name: 'Teknosa', category: 'Elektronik', donationRate: 1, logoUrl: 'https://logo.clearbit.com/teknosa.com', link: '#', followers: 3500000, type: 'brand' },
    { id: '123', name: 'Huawei', category: 'Elektronik', donationRate: 2, logoUrl: 'https://logo.clearbit.com/huawei.com', link: '#', followers: 10000000, type: 'brand' },
    ...
    // Mücevher & Saat
    { id: '130', name: 'Altınbaş', category: 'Mücevher', donationRate: 5, logoUrl: 'https://logo.clearbit.com/altinbas.com', link: '#', followers: 900000, type: 'brand' },
    { id: '131', name: 'Saat&Saat', category: 'Saat', donationRate: 6, logoUrl: 'https://logo.clearbit.com/saatvesaat.com.tr', link: '#', followers: 1100000, type: 'brand' },
    { id: '132', name: 'Lizay Pırlanta', category: 'Mücevher', donationRate: 8, logoUrl: 'https://logo.clearbit.com/lizaypirlanta.com', link: '#', followers: 400000, type: 'brand' },
    { id: '133', name: 'Konyalı Saat', category: 'Saat', donationRate: 7, logoUrl: 'https://logo.clearbit.com/konyalisaat.com.tr', link: '#', followers: 500000, type: 'brand' },
    { id: '134', name: 'Zwilling', category: 'Mutfak', donationRate: 9, logoUrl: 'https://logo.clearbit.com/zwilling.com/tr', link: '#', followers: 200000, type: 'brand' },
    { id: '135', name: 'Hizlisaat.com', category: 'Saat', donationRate: 10, logoUrl: 'https://logo.clearbit.com/hizlisaat.com', link: '#', followers: 150000, type: 'brand' },
...
export const socialEnterprises: Brand[] = [
     { id: 'social-1', name: 'Efes Tarlası Yaşam Köyü', category: 'Tarım', donationRate: 0, logoUrl: '', link: '#', followers: 800, type: 'social' },
     { id: 'social-2', name: 'Buldan Eğitim ve Dayanışma Vakfı', category: 'Eğitim', donationRate: 0, logoUrl: '', link: '#', followers: 1500, type: 'social' },
     { id: 'social-3', name: 'Askıda İyilik', category: 'Sosyal Yardım', donationRate: 0, logoUrl: '', link: '#', followers: 750, type: 'social' },
];

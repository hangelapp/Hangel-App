...
export const qrPaymentCardData = [
    { id: 'bireysel', type: 'Bireysel', bgColor: 'bg-gradient-to-br from-red-600 to-rose-500', number: '5549601000001234', owner: 'İsmail Hilmi ADIGÜZEL', expiry: '12/28', balance: '1.250,75 ₺', ngoId: '1', cvv: '123' },
    { id: 'ticari', type: 'Ticari', bgColor: 'bg-gradient-to-br from-gray-700 to-gray-900', number: '5549601000005678', owner: 'Hangel A.Ş.', expiry: '10/27', balance: '15.450,00 ₺', ngoId: '2', cvv: '456' },

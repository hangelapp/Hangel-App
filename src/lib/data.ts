...
export const districtsData: { [key: string]: string[] } = {
  ...
  "İstanbul": ["Adalar", "Arnavutköy", "Ataşehir", "Avcılar", "Bağcılar", "Bahçelievler", "Bakırköy", "Başakşehir", "Bayrampaşa", "Beşiktaş", "Beykoz", "Beylikdüzü", "Beyoğlu", "Büyükcheckmece", "Çatalca", "Çekmeköy", "Esenler", "Esenyurt", "Eyüpsultan", "Fatih", "Gaziosmanpaşa", "Güngören", "Kadıköy", "Kâğıthane", "Kartal", "Küçükçekmece", "Maltepe", "Pendik", "Sancaktepe", "Sarıyer", "Silivri", "Sultanbeyli", "Sultangazi", "Şile", "Şişli", "Tuzla", "Ümraniye", "Üsküdar", "Zeytinburnu"],
...
export const neighborhoodsData: { [city: string]: { [district: string]: string[] } } = {
  ...
  "Ankara": {
    "Çankaya": ["Bahçelievler", "Kavaklıdere", "Kızılay", "Ayrancı", "Anıttepe"],
    "Yenimahalle": ["Batıkent", "Demetevler", "Şentepe"]
  },
  "İzmir": {
    "Karşıyaka": ["Bostanlı", "Mavişehir", "Bahçelievler", "Alaybey"],
    "Bornova": ["Kazımdirik", "Erzene", "Özkanlar"]
  }
};
...
export const volunteeringOpportunities: Volunteering[] = Array.from({ length: 21 }, (_, i) => ({
    id: `opp-${i + 1}`,
    title: [
        "Sahil Temizliği Etkinliği", "Öğrencilere Matematik Desteği", "Sokak Hayvanları Besleme", 
        "Huzurevi Ziyareti", "Dijital İçerik Üretimi", "Tercüme Gönüllüsü", "Fidan Dikme", 
        "Afet Bilinci Eğitmeni", "Kütüphane Düzenleme", "Gıda Kolisi Hazırlama",
        "Kampüs Elçisi", "Grafik Tasarım Desteği", "Hukuki Danışmanlık", "Yazılım Eğitmeni",
        "İşaret Dili Tercümanı", "Görme Engellilere Kitap Okuma", "Kan Bağışı Organizasyonu",
        "İlk Yardım Yardımcısı", "Müze Rehberi", "Sürdürülebilirlik Danışmanı", "Veri Analizi Desteği"
    ][i % 21],
...
// --- Öğrenci Kulüpleri (5 Adet) ---
export const studentClubs: StudentClub[] = [
    { id: 'club-1', name: 'İTÜ Girişimcilik Kulübü', university: 'İstanbul Teknik Üniversitesi', type: 'university', avatarUrl: 'https://logo.clearbit.com/itu.edu.tr', coverPhotoUrl: 'https://picsum.photos/seed/club1/1200/400', members: 1500, points: 25000, description: 'Girişimcilik ekosistemine yön veren öğrenci topluluğu.', vision: 'En iyi girişimci kulübü olmak.', joinDate: '2023-01-01', contact: { email: 'iletisim@itugirisim.org', phone: '0212 123 45 67', website: 'https://itugirisim.org' } },
    { id: 'club-2', name: 'Boğaziçi Sosyal Hizmet', university: 'Boğaziçi Üniversitesi', type: 'university', avatarUrl: 'https://logo.clearbit.com/boun.edu.tr', coverPhotoUrl: 'https://picsum.photos/seed/club2/1200/400', members: 800, points: 18000, description: 'Sosyal sorumluluk projeleri geliştiren topluluk.', vision: 'Değişimin kampüsteki adı.', joinDate: '2023-01-01', contact: { email: 'social@boun.edu.tr', phone: '0212 345 67 89', website: 'https://social.boun.edu.tr' } },
    { id: 'club-3', name: 'ODTÜ Hayvan Dostları', university: 'Orta Doğu Teknik Üniversitesi', type: 'university', avatarUrl: 'https://logo.clearbit.com/metu.edu.tr', coverPhotoUrl: 'https://picsum.photos/seed/club3/1200/400', members: 600, points: 12000, description: 'Kampüs hayvanlarını koruma topluluğu.', vision: 'Patili dostlarımızın sesi.', joinDate: '2023-01-01', contact: { email: 'hayvanlar@metu.edu.tr', phone: '0312 123 45 67', website: 'https://hayvanlar.metu.edu.tr' } },
    { id: 'club-4', name: 'Marmara Kızılay Kulübü', university: 'Marmara Üniversitesi', type: 'university', avatarUrl: 'https://logo.clearbit.com/marmara.edu.tr', coverPhotoUrl: 'https://picsum.photos/seed/club4/1200/400', members: 1200, points: 22000, description: 'Kızılay gönüllü gençlik topluluğu.', vision: 'Yardımlaşma bilincini yaymak.', joinDate: '2023-01-01', contact: { email: 'kizilay@marmara.edu.tr', phone: '0216 123 45 67', website: 'https://kizilay.marmara.edu.tr' } },
    { id: 'club-5', name: 'Yıldız Teknik Çevre Kulübü', university: 'Yıldız Teknik Üniversitesi', type: 'university', avatarUrl: 'https://logo.clearbit.com/yildiz.edu.tr', coverPhotoUrl: 'https://picsum.photos/seed/club5/1200/400', members: 950, points: 19500, description: 'Doğa koruma ve sürdürülebilirlik topluluğu.', vision: 'Yeşil bir kampüs ve gelecek.', joinDate: '2023-01-01', contact: { email: 'cevre@yildiz.edu.tr', phone: '0212 123 45 67', website: 'https://cevre.yildiz.edu.tr' } }
];

// --- Etkinlikler (5 Adet) ---
export const events: Event[] = [
    { id: 'event-1', slug: 'zirve-2024', name: 'Girişimcilik Zirvesi', organizer: 'İTÜ Girişimcilik Kulübü', type: 'Zirve', date: '2024-12-01', startDate: '2024-12-01 09:00', endDate: '2024-12-01 18:00', location: { type: 'Fiziksel', address: 'İTÜ SDK', city: 'İstanbul', district: 'Sarıyer' }, language: 'Türkçe', participationCondition: 'Herkese Açık', capacity: { current: 450, max: 500 }, tags: ['Girişimcilik', 'Teknoloji'], imageUrl: 'https://picsum.photos/seed/ev1/800/400', description: 'Yılın en büyük öğrenci zirvesi.', providesCertificate: true },
    { id: 'event-2', slug: 'konser-2024', name: 'Dayanışma Konseri', organizer: 'Boğaziçi Sosyal Hizmet', type: 'Konser', date: '2024-11-15', startDate: '2024-11-15 20:00', endDate: '2024-11-15 23:00', location: { type: 'Fiziksel', address: 'Albert Long Hall', city: 'İstanbul', district: 'Beşiktaş' }, language: 'Türkçe', participationCondition: 'Biletli', capacity: { current: 300, max: 350 }, tags: ['Müzik', 'Yardım'], imageUrl: 'https://picsum.photos/seed/ev2/800/400', description: 'Geliri burs fonuna aktarılacaktır.', providesCertificate: false },
    { id: 'event-3', slug: 'robotik-2024', name: 'Robotik Günleri', organizer: 'ODTÜ Hayvan Dostları', type: 'Yarışma', date: '2024-10-10', startDate: '2024-10-10 10:00', endDate: '2024-10-12 17:00', location: { type: 'Fiziksel', address: 'ODTÜ KKM', city: 'Ankara', district: 'Çankaya' }, language: 'Türkçe/İngilizce', participationCondition: 'Öğrencilere Özel', capacity: { current: 200, max: 300 }, tags: ['Teknoloji', 'Robotik'], imageUrl: 'https://picsum.photos/seed/ev3/800/400', description: 'Teknoloji ve inovasyon buluşması.', providesCertificate: true },
    { id: 'event-4', slug: 'kan-bagisi', name: 'Kan Bağışı Kampanyası', organizer: 'Marmara Kızılay Kulübü', type: 'Kampanya', date: '2024-09-20', startDate: '2024-09-20 09:00', endDate: '2024-09-20 17:00', location: { type: 'Fiziksel', address: 'Göztepe Kampüsü', city: 'İstanbul', district: 'Kadıköy' }, language: 'Türkçe', participationCondition: 'Herkese Açık', capacity: { current: 100, max: 1000 }, tags: ['Sağlık', 'Bağış'], imageUrl: 'https://picsum.photos/seed/ev4/800/400', description: 'Hayat kurtarmak senin elinde.', providesCertificate: false },
    { id: 'event-5', slug: 'iklim-calistayi', name: 'İklim Krizi Çalıştayı', organizer: 'Yıldız Teknik Çevre Kulübü', type: 'Çalıştay', date: '2024-08-25', startDate: '2024-08-25 13:00', endDate: '2024-08-25 17:00', location: { type: 'Online', address: 'Zoom', city: 'Online', district: 'Online' }, language: 'Türkçe', participationCondition: 'Kayıtlı Katılım', capacity: { current: 85, max: 100 }, tags: ['Çevre', 'Sürdürülebilirlik'], imageUrl: 'https://picsum.photos/seed/ev5/800/400', description: 'Geleceği birlikte tasarlıyoruz.', providesCertificate: true }
];

...
export const ngos: NGO[] = [
    {
        ...
        about: "Türkiye Çöl Olmasın!",
        joinDate: "2023-01-10",
        supportedSDGs: ['İklim Eylemi'],
        beneficiaryGroups: ['Çevre'],
        memberOf: ['Açık Açık'],
    ...
    },
    {
        ...
        about: "Ahbap, toplumsal yardımlaşma hareketidir.",
        joinDate: "2023-02-20",
        supportedSDGs: ['Yoksulluğa Son'],
...
export const schoolRepresentatives: SchoolRepresentative[] = [
    { id: '1', name: 'Can Demir', school: 'İTÜ', type: 'university', role: 'Başkan', avatarUrl: 'https://i.pravatar.cc/150?u=can', linkedinUrl: '#' }
];

export const volunteeringOpportunities: Volunteering[] = [
    { id: '1', title: 'Afet Bölgesi Yardım Dağıtımı', organization: 'Ahbap Derneği', ngoId: '2', location: { city: 'Hatay', district: 'Antakya', type: 'Saha' }, commitment: 'Dönemsel', volunteerCount: { needed: 50, applications: 120 }, dates: { applicationStart: '2024-07-01', applicationEnd: '2024-07-25', eventStart: '2024-08-01', eventEnd: '2024-08-08' }, hours: { start: '09:00', end: '18:00', total: 56 }, socialArea: 'Afet', points: 500, ngoTransparencyScore: 95, taskType: 'Dönemsel', providesCertificate: true, earnedBadges: [], hasPreTraining: true, description: 'Yardım dağıtımı.', amenities: { transport: true, food: true, accommodation: true } }
];
...
export const certificates: Certificate[] = [
    { id: '1', title: 'Afet Gönüllülüğü', organization: 'Ahbap', date: '15.07.2024', linkedinUrl: '#' }
];

export const helpTopics: HelpTopic[] = [
    { icon: 'Info', title: 'Genel Bilgiler', slug: 'genel', description: 'Platform hakkında.', subtopics: [{ title: 'Nedir?', link: '#', content: 'Hangel nedir.' }] }
];

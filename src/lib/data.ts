...
export const badges: Badge[] = [
    ...
    { id: '7', name: 'Gençlik Destekçisi', iconName: Users, level: 'Demir', socialArea: 'Gençlik', pointsRequired: 250, currentPoints: 100 },
    { id: '8', name: 'Gençlik Destekçisi', iconName: Users, level: 'Bronz', socialArea: 'Gençlik', pointsRequired: 500, currentPoints: 100 },
    { id: '9', name: 'Hayvan Dostu', iconName: Heart, level: 'Demir', socialArea: 'Hayvan', pointsRequired: 250, currentPoints: 550 },
    { id: '10', name: 'Hayvan Dostu', iconName: Heart, level: 'Bronz', socialArea: 'Hayvan', pointsRequired: 500, currentPoints: 550 },
    { id: '11', name: 'Çocuk Dostu', iconName: Smile, level: 'Demir', socialArea: 'Çocuk', pointsRequired: 250, currentPoints: 260 },
    { id: '12', name: 'Çocuk Dostu', iconName: Smile, level: 'Bronz', socialArea: 'Çocuk', pointsRequired: 500, currentPoints: 260 },
    { id: '13', name: 'Gıda Güvenliği', iconName: Utensils, level: 'Demir', socialArea: 'Gıda', pointsRequired: 250, currentPoints: 50 },
    { id: '14', name: 'Gıda Güvenliği', iconName: Utensils, level: 'Bronz', socialArea: 'Gıda', pointsRequired: 500, currentPoints: 50 },
    { id: '15', name: 'Afet Gönüllüsü', iconName: Siren, level: 'Demir', socialArea: 'Afet', pointsRequired: 250, currentPoints: 300 },
    { id: '16', name: 'Afet Gönüllüsü', iconName: Siren, level: 'Bronz', socialArea: 'Afet', pointsRequired: 500, currentPoints: 300 },
    { id: '17', name: 'Eşitlik Savunucusu', iconName: Scale, level: 'Demir', socialArea: 'Eşitlik', pointsRequired: 250, currentPoints: 0 },
    { id: '18', name: 'Eşitlik Savunucusu', iconName: Scale, level: 'Bronz', socialArea: 'Eşitlik', pointsRequired: 500, currentPoints: 0 },
    { id: '19', name: 'İnovasyon Lideri', iconName: Lightbulb, level: 'Demir', socialArea: 'İnovasyon', pointsRequired: 250, currentPoints: 120 },
    { id: '20', name: 'İnovasyon Lideri', iconName: Lightbulb, level: 'Bronz', socialArea: 'İnovasyon', pointsRequired: 500, currentPoints: 120 },
    { id: '21', name: 'İş Dünyası Destekçisi', iconName: Briefcase, level: 'Demir', socialArea: 'İş Dünyası', pointsRequired: 250, currentPoints: 0 },
    { id: '22', name: 'İş Dünyası Destekçisi', iconName: Briefcase, level: 'Bronz', socialArea: 'İş Dünyası', pointsRequired: 500, currentPoints: 0 },
    { id: '23', name: 'Bilim Destekçisi', iconName: FlaskConical, level: 'Demir', socialArea: 'Bilim', pointsRequired: 250, currentPoints: 0 },
    { id: '24', name: 'Bilim Destekçisi', iconName: FlaskConical, level: 'Bronz', socialArea: 'Bilim', pointsRequired: 500, currentPoints: 0 },
    { id: '25', name: 'Engelsiz Yaşam', iconName: Accessibility, level: 'Demir', socialArea: 'Engelli', pointsRequired: 250, currentPoints: 400 },
    { id: '26', name: 'Engelsiz Yaşam', iconName: Accessibility, level: 'Bronz', socialArea: 'Engelli', pointsRequired: 500, currentPoints: 400 },
    { id: '27', name: 'Yaşlı Dostu', iconName: PersonStanding, level: 'Demir', socialArea: 'Yaşlılık', pointsRequired: 250, currentPoints: 0 },
    { id: '28', name: 'Yaşlı Dostu', iconName: PersonStanding, level: 'Bronz', socialArea: 'Yaşlılık', pointsRequired: 500, currentPoints: 0 },
    { id: '29', name: 'Sanat Destekçisi', iconName: Palette, level: 'Demir', socialArea: 'Sanat', pointsRequired: 250, currentPoints: 0 },
    { id: '30', name: 'Sanat Destekçisi', iconName: Palette, level: 'Bronz', socialArea: 'Sanat', pointsRequired: 500, currentPoints: 0 },
    { id: '31', name: 'Tarım Gönüllüsü', iconName: Sprout, level: 'Demir', socialArea: 'Tarım', pointsRequired: 250, currentPoints: 0 },
    { id: '32', name: 'Tarım Gönüllüsü', iconName: Sprout, level: 'Bronz', socialArea: 'Tarım', pointsRequired: 500, currentPoints: 0 },
    { id: '33', name: 'Sağlık Gönüllüsü', iconName: HeartPulse, level: 'Demir', socialArea: 'Sağlık', pointsRequired: 250, currentPoints: 0 },
    { id: '34', name: 'Sağlık Gönüllüsü', iconName: HeartPulse, level: 'Bronz', socialArea: 'Sağlık', pointsRequired: 500, currentPoints: 0 },
    { id: '35', name: 'Hoşgörü Elçisi', iconName: Handshake, level: 'Demir', socialArea: 'İnanç', pointsRequired: 250, currentPoints: 0 },

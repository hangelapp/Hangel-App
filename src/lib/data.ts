...
// --- Türkiye İlçe Verileri (Kapsamlı Liste) ---
export const districtsData: { [key: string]: string[] } = {
  ...
  "Bolu": ["Bolu", "Dörtdivan", "Gerede", "Göynücek", "Kıbrıscık", "Mengen", "Mudurnu", "Seben", "Yeniçağa"],
...
// --- Mahalle Verileri (Referans Hatalarını Önlemek İçin Tanımlı) ---

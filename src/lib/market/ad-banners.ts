...
export const SEED_MARKET_ADS: MarketAdBanner[] = [
  ...
  },
  {
    ...
    design: {
      // Apple açık kimliği (beyaz/gri) — beyaz zeminli ürün görseli sorunsuz oturur.
      bg: '#f5f5f7',
      fg: '#1d1d1f',
      accent: '#6e6e73',
      ctaBg: '#0071e3',
      ctaFg: '#ffffff',
      logoText: '',
      imageUrl: 'https://reimg-teknosa-cloud-prod.mncdn.com/mnresize/600/600/productimage/125079197/125079197_0_MC/bb8148c459e6499da2935cc4cbc978bb.jpg',
    },
    placements: ['home', 'category', 'brand', 'store'],
    rowSlot: 10,
    order: 0,

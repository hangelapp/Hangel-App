...
export const HANGEL_AI_CONTEXT_EN = [
  ...
  '- Mobile: Capacitor (iOS + Android). The app is a WebView wrapper that REMOTELY loads https://hangel.org.tr (server.url). IMPORTANT: a web deploy reflects in the mobile app INSTANTLY (JS/route changes need no rebuild; only native config/plugin changes require a rebuild).',
  ...
  '',
  '9) PLATFORMS',
  '- Web: https://hangel.org.tr (App Hosting); NGOs get *.hangel.org.tr subdomains (Cloudflare for SaaS).',
  ...
  '- Firebase project: hangel-new-v18-87297865-9bcc3. GitHub: hangelapp/new-app (main). Domain: hangel.org.tr.',

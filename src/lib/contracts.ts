...
<h4>11. Çerezler</h4>
<p>hangel; oturum yönetimi, güvenlik, performans ölçümü ve tercihlerin hatırlanması amacıyla çerez ve benzeri teknolojiler kullanır. Zorunlu olmayan çerezler için onayınız alınır (GDPR ve ePrivacy Direktifi 2002/58/EC). Ayrıntılar ayrı <a href="/settings/contracts/cerez-politikasi" rel="noopener">Çerez Politikası</a>'nda düzenlenmiştir.</p>
...
<p>hangel, kullanıcı üzerinde hukuki sonuç doğuran veya benzer biçimde önemli etki üreten <strong>tamamen otomatik bireysel kararları</strong> kural olarak uygulamaz. Böyle bir işleme öngörülürse, GDPR Art. 22 ve KVKK m.11/1-g güvenceleri (insan müdahalesi talep etme, görüş bildirme, karara itiraz) sağlanır.</p>
...
<p>hangel, uygun olduğu alanlarda etkinin parasal değerini SROI yöntemiyle tahmin etmeyi hedefler. SROI; oluşturulan sosyal değerin parasal karşılığının, kullanılan kaynağa (yatırıma) oranıdır. Hesaplamada şu düzeltmeler uygulanır: <strong>deadweight</strong> (hangel olmasaydı yine de gerçekleşecek değişim), <strong>attribution</strong> (etkinin başka aktörlere atfedilebilen kısmı), <strong>displacement</strong> (başka yere kayan etki) ve <strong>drop-off</strong> (etkinin zamanla azalması). hangel, SROI sonuçlarının tahmini niteliğini ve dayandığı varsayımları açıkça beyan etmeyi; sonuçları kesin bir mali getiri vaadi gibi sunmaktan kaçınmayı taahhüt eder.</p>

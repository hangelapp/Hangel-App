...
export const DEFAULT_SLIDES: Slide[] = [
  ...
  { kind: 'stats', title: 'Sosyal Girişimcilik Eğitimleri ve Konferanslar', stats: [{ big: '29', label: 'üniversite' }, { big: '161', label: 'konferans' }, { big: '300+', label: 'eğitim' }], foot: '18 belediye · 12 ticaret odası · onlarca lise iş birliğiyle.', row: true },

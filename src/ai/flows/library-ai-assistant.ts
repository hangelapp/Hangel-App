...
const DEFAULT_SYSTEM_PROMPT =
  'You are the "hangel Kütüphane AI Asistanı" (Library AI Assistant). Your goal is to help users navigate and understand the resources available in the hangel Library.\n\n' +

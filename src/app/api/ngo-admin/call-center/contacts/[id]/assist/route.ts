...
async function authorize(req: NextRequest): Promise<Ctx | null> {
  ...
  try {
    ...
    // yöneten kullanıcı için kritik). Caller o kuruma üyeyse (managed*Id==header) ya da
    // super-admin ise header'daki kurum kullanılır; yoksa ilk dolu managed*Id'ye düşer.

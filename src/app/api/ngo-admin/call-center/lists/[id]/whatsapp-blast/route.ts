...
async function authorize(req: NextRequest): Promise<CallerContext | null> {
  ...
  try {
    ...
    // yöneten kullanıcı için kritik). Caller o kuruma üye ise (managedNgoId/managedBrandId/
    // managedClubId == header) ya da super-admin ise header'daki kurum kullanılır; yoksa

...
const Footer = () => {
    const footerGroups = [
        ...
        { title: "hangel Derneği", links: [{label: "Dernek Hakkında", href: "/association/about"}, {label: "Dernek Etkinlikleri", href: "/association/events"}, {label: "Uluslararası Çalıştay", href: "/association/workshop"}, {label: "Mevzuat Taslağı", href: "/association/legislation"}] },

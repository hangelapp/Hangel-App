...
const Footer = () => {
    const footerGroups = [
        ...
        { title: "Destek", links: [{label: "Destek Merkezi", href: "/support"}, {label: "Geri Bildirim", href: "/support"}, {label: "İletişim", href: "/about"}, {label: "Bilgi Toplumu", href: "/bilgi-toplumu-hizmetleri"}] },

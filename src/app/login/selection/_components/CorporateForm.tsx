                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-2 pt-6 border-t border-dashed">
                        ...
                        <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/stk-uyelik" className="font-bold text-primary underline">STK Üyelik Sözleşmesi</a>&apos;ni okudum ve kabul ediyorum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox
                            ...
                            />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/seffaflik" className="font-bold text-primary underline">Şeffaflık Endeksi Esasları</a>&apos;nı kabul ediyorum
                            </span>
                        </label>
                    </div>
                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-2 pt-6 border-t border-dashed">
                        ...
                        <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/affiliate-politikasi" className="font-bold text-primary underline">Bağış ve Affiliate Politikası</a>&apos;nı kabul ediyorum
                            </span>
                        </label>
                    </div>
                ...
                <div className="space-y-12">
                    ...
                    <div className="space-y-2 pt-6 border-t border-dashed">
                        ...
                        <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/ogrenci-kulup" className="font-bold text-primary underline">Öğrenci Kulüp Sözleşmesi</a>&apos;ni okudum ve kabul ediyorum
                            </span>
                        </label>
                    </div>

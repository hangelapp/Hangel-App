                    ...
                    <div className="space-y-2 pt-4 border-t border-dashed">
                        <label className="flex items-start gap-2 cursor-pointer">
                            ...
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/kullanici-sozlesmesi" className="font-bold text-primary underline">Kullanıcı Sözleşmesi</a>&apos;ni okudum ve kabul ediyorum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.kvkk} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, kvkk: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/kvkk-aydinlatma-metni" className="font-bold text-primary underline">KVKK Aydınlatma Metni</a>&apos;ni okudum ve kabul ediyorum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.privacy} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, privacy: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/gizlilik-politikasi" className="font-bold text-primary underline">Gizlilik Politikası</a>&apos;nı okudum ve kabul ediyorum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.cookies} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, cookies: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/cerez-politikasi" className="font-bold text-primary underline">Çerez Politikası</a>&apos;nı kabul ediyorum
                            </span>
                        </label>
                    </div>
    ...
    if (step === 'whatsapp-enter') {
        return (
            <div className="space-y-4">
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleSendWhatsAppCode(); }} className="space-y-4">
                    ...
                    <div className="space-y-2 pt-4 border-t border-dashed">
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.userAgreement} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, userAgreement: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/kullanici-sozlesmesi" className="font-bold text-primary underline">Kullanıcı Sözleşmesi</a>&apos;ni okudum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.kvkk} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, kvkk: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/kvkk-aydinlatma-metni" className="font-bold text-primary underline">KVKK</a>&apos;yı kabul ediyorum
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.privacy} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, privacy: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/gizlilik-politikasi" className="font-bold text-primary underline">Gizlilik Politikası</a>
                            </span>
                        </label>
                        <label className="flex items-start gap-2 cursor-pointer">
                            <Checkbox className="h-5 w-5 mt-0.5" checked={agreements.cookies} onCheckedChange={(c) => setAgreements(prev => ({ ...prev, cookies: !!c }))} />
                            <span className="text-xs text-muted-foreground leading-relaxed">
                                <a href="/settings/contracts/cerez-politikasi" className="font-bold text-primary underline">Çerez Politikası</a>
                            </span>
                        </label>
                    </div>
                ...
                {/* Passkey (Face ID) girişi — native app'e webcredentials entitlement'lı
                    yeni derleme alınınca geri açılacak (buton kaldırıldı, arka uç hazır). */}

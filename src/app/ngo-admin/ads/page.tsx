    ...
    const handleSaveIntegration = () => {
        ...
        setTimeout(() => {
            toast({ 
                ...
                description: "Ajans API anahtarları başarıyla güncellendi." 
            });
            setIsSaving(false);
        }, 1500);
    };
    ...
    const handleTestConnection = () => {
        ...
        setTimeout(() => {
            toast({
                ...
                description: "Tüm ajans servisleri (3/3) yanıt veriyor.",
            });
            setIsTesting(false);
        }, 2000);
    };
        ...
        <div className="space-y-6 animate-in fade-in-0 max-w-5xl mx-auto p-4 sm:p-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <p className="text-muted-foreground text-sm">Ajans entegrasyonlarını ve reklam alanlarını yönetin.</p>
                    </div>
                </div>
            </div>
            ...
            <Tabs defaultValue="integration">
                <TabsList className="grid w-full grid-cols-3 max-w-lg">
                    ...
                    <TabsTrigger value="integration"><KeyRound className="mr-2 h-4 w-4" /> Ajans Bağlantıları</TabsTrigger>
                </TabsList>
                            ...
                            <div className="grid grid-cols-1 gap-3">
                                {agencies.map((agency) => (
                                    <div key={agency.id} className="flex items-center justify-between p-4 bg-background border rounded-xl shadow-sm">
                                        ...
                                        <Badge className="bg-green-100 text-green-700 border-green-200">BAĞLI</Badge>
                                    </div>
                                ))}
                            </div>

...
// Etkinlik tema rengi hazır paleti — okunur, baskıya uygun 8 renk. Seçilen renk
// yaka kartına (--acc) ve detay vurgularına yansır.
...
export default function EventManagementPage() {
    ...
    // kırılmasın diye). Yalnız yeni etkinlikte / slug yoksa yeniden üretilir.
    ...
    // Etkinlik tema rengi (hex) — yaka kartı + detay vurgularına yansır. Boş = hangel turuncusu.
    ...
    const handleDuplicate = async (ev: ClubEventDoc) => {
        ...
        try {
            ...
            // slug: yeni benzersiz değeri geçir (rest'teki eski slug'ı ezmesin).
    ...
    const handleCreateEvent = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // etkinlikte (veya eski kayıtta slug yoksa) benzersiz slug üretilir.
            ...
            // Tema rengi — geçerli hex ise yaz, değilse boş (yaka kartı hangel turuncusuna düşer).
                                            ...
                                            <div key={s.id} className="p-3 border rounded-xl bg-card space-y-2">
                                                <div className="space-y-1">
                                                    ...
                                                    <Input
                                                        ...
                                                        placeholder="Örn. Sosyal Business Global"
                                                    />
                                                </div>
                                                <div className="space-y-1">
                                                    <Label className="text-xs text-muted-foreground">Web sitesi</Label>

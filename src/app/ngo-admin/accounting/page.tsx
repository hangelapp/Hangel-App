        ...
        <div className="space-y-6 animate-in fade-in-0 max-w-5xl mx-auto p-3 sm:p-4 md:p-6">
            ...
            <Tabs defaultValue="integration">
                <TabsList className="grid w-full grid-cols-3 max-w-lg">
                    <TabsTrigger value="integration" className="gap-1.5 px-2"><Settings2 className="h-4 w-4 shrink-0" /> <span className="truncate">{t('ngoAdminAccounting.tabIntegration')}</span></TabsTrigger>
                    <TabsTrigger value="overview" className="gap-1.5 px-2"><Calculator className="h-4 w-4 shrink-0" /> <span className="truncate">{t('ngoAdminAccounting.tabOverview')}</span></TabsTrigger>
                    <TabsTrigger value="api" className="gap-1.5 px-2"><LinkIcon className="h-4 w-4 shrink-0" /> <span className="truncate">{t('ngoAdminAccounting.tabApi')}</span></TabsTrigger>
                </TabsList>
                ...
                <TabsContent value="integration" className="mt-6 space-y-6">
                            ...
                            <Card key={erp.id} className="hover:border-primary transition-colors cursor-pointer group">
                                <CardContent className="p-4 flex flex-col items-center text-center space-y-3">
                                    ...
                                    <div>
                                        ...
                                        <Badge variant={erp.status === t('ngoAdminAccounting.statusConnected') ? 'default' : 'secondary'} className="text-xs mt-1">
                                            {erp.status}
                                        </Badge>
                                    </div>
                                    <Button
                    ...
                    <Card>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-4 border border-primary/20 rounded-xl bg-primary/10 text-foreground text-xs flex items-center gap-3">
                ...
                <TabsContent value="overview" className="mt-6 space-y-6">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                        <Card className="bg-emerald-50 border-emerald-200 dark:bg-emerald-900/20 dark:border-emerald-800/40">
                            <CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-emerald-700 dark:text-emerald-300">{t('ngoAdminAccounting.incomeLabel')}</CardTitle></CardHeader>
                            <CardContent><p className="text-2xl font-bold text-emerald-800 dark:text-emerald-200">45,250 ₺</p></CardContent>
                        </Card>
                        <Card className="bg-rose-50 border-rose-200 dark:bg-rose-900/20 dark:border-rose-800/40">
                            <CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-rose-700 dark:text-rose-300">{t('ngoAdminAccounting.expenseLabel')}</CardTitle></CardHeader>
                            <CardContent><p className="text-2xl font-bold text-rose-800 dark:text-rose-200">12,800 ₺</p></CardContent>
                        </Card>
                        <Card className="bg-sky-50 border-sky-200 dark:bg-sky-900/20 dark:border-sky-800/40">
                            <CardHeader className="pb-2"><CardTitle className="text-sm font-medium text-sky-700 dark:text-sky-300">{t('ngoAdminAccounting.netLabel')}</CardTitle></CardHeader>
                            <CardContent><p className="text-2xl font-bold text-sky-800 dark:text-sky-200">32,450 ₺</p></CardContent>
                        </Card>
                    </div>
                    <Card>
                                ...
                                <Table>
                                    ...
                                    <TableBody>
                                        <TableRow>
                                            ...
                                            <TableCell className="text-right text-emerald-600 dark:text-emerald-400 whitespace-nowrap">+12,400 ₺</TableCell>
                                        </TableRow>
                                        <TableRow>
                                            ...
                                            <TableCell className="text-right text-rose-600 dark:text-rose-400 whitespace-nowrap">-4,500 ₺</TableCell>
                                        </TableRow>
                                    </TableBody>
                                </Table>
                            </div>

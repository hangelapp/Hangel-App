        ...
        <Card>
            ...
            <CardContent className="p-0">
                 <div className="flex flex-col divide-y">
                    ...
                    <SettingsLink href="/qr-payment" icon={Wallet} label="Cüzdan ve Ödeme Yöntemleri" iconColor="bg-teal-500" />
                    <SettingsLink href="/settings" icon={Shield} label="Güvenlik ve Şifre" iconColor="bg-green-500" />
                 </div>
            </CardContent>
        </Card>
                ...
                <Button variant="secondary" className="w-full justify-start text-base p-6">
                 ...
                 <AlertDialog>
                  <AlertDialogTrigger asChild>
                     <Button variant="destructive" className="w-full justify-start bg-red-100 text-destructive hover:bg-red-200 text-base p-6">

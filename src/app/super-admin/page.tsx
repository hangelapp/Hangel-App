...
const superAdminNavSections = [
    ...
    },
    {
        ...
        items: [
            ...
            { href: '/super-admin/outreach', label: 'Outreach Veritabanı', icon: 'Database', description: '100.967 dernek + 6.682 vakıf + 3.500 kayıt: STK ve il müdürlüğü iletişim (telefon/e-posta) verisi; ara, filtrele, dışa aktar, kampanyaya gönder.' },

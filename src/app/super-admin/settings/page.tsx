...
const SETTINGS_SECTIONS = [
  ...
  { id: 'call-center-hub', label: 'Hangel Call Center', icon: PhoneCall, color: 'bg-cyan-600',
    href: '/super-admin/call-center',
    description: 'Hangel iç ekibi için canlı çağrılar + geçmiş + KVKK audit (sadece metadata, recording erişimi yok).' },

...
const grants: Array<{
...
}> = [
  {
    ...
    perks: [
      ...
      "Google Workspace: 2.000 kullanıcıya kadar ücretsiz kurumsal mail (@stkadı.org uzantılı; yeni hesaplarda başlangıç 300)",
      'Google Drive: 100 TB ortak havuz depolama (tüm kuruluş için)',
      ...
      'Cloud kredi programı: ücretsiz Google Cloud kredileri + seçili ücretsiz servisler (aylık limitli) — güncel tutar resmi sayfada',
    ],
    supportsUpTo: '2.000 kullanıcıya kadar mail + Drive + Meet (başlangıç 300)',
  },
  {
    ...
    perks: [
      ...
      'Kullanıcı başına 100 GB bulut depolama',
  ...
  },
  {
    ...
    perks: [
      ...
      'Üniversiteye bağlı öğrenci kulüpleri/toplulukları için (uygunluk kriterli)',
    ],
    supportsUpTo: 'Kabul edilen topluluğa toplam 65.000 ₺ değerinde ücretsiz hizmet paketi',
  },
  {
    name: 'Help Steps',
    offer: 'Kullanıcıların adımlarını (reklam izleyerek) bağışa dönüştüren mobil platform; resmi STK\'lar adım hedefli kampanya açar, destek marka reklam/sponsorluk gelirinden karşılanır.',
    how: 'helpsteps.app üzerinden resmi STK olarak kaydolun; adım hedefli kampanya + protokol ile açın. Hedefe ulaşınca destek banka yoluyla aktarılır.',
    href: 'https://helpsteps.app/',
    perks: [
      'Adım tabanlı bağış: kullanıcı adımlarını kampanyaya yönlendirir (günde en fazla 25.000 adım)',
      'Resmi STK statüsüyle kampanya açma (protokollü)',
      'Kurumsal iş birliği: Getir, Nestlé, Migros, Decathlon dahil 40+ marka',
      'Hedefe ulaşan kampanya desteği banka yoluyla aktarılır',
    ],
    supportsUpTo: 'Kampanya adım hedefli; kullanıcı başına günde 25.000 adım',
  },
  {
    name: 'hangel',
  ...
  },
  {
    ...
    href: 'https://gonulluyuzbiz.gov.tr/',
    perks: [
      'Ücretsiz STK paneli + proje yayınlama',
      'Toplu kurumsal gönüllü ekibi tahsisi',
      'Etki raporlama',
    ],
    supportsUpTo: 'Kontenjanlı gönüllü çağrıları (her ilanın katılımcı kotası var)',
  },
  {
    ...
    perks: [
      'Microsoft 365 Business Basic: 300 koltuğa kadar ücretsiz (web + mobil Office + Teams + 1 TB OneDrive); Business Premium/Standard %75\'e kadar indirimli',
      'Business Premium/Standard dahil M365 tekliflerinde %75\'e kadar indirim',
      'Azure bulut kredisi: yıllık 2.000 $ ücretsiz Azure kullanımı',
    ...
    supportsUpTo: '300 koltuğa kadar Business Basic ücretsiz + Business Premium/Standard %75\'e kadar indirimli',
  },
  {
    ...
    perks: [
      ...
      'API kredileri OpenAI for Nonprofits kapsamında DEĞİL (ayrı programlarda: Researcher Access, OpenAI for Startups)',
    ...
    supportsUpTo: 'ChatGPT Business: 2 kullanıcıdan başlar (~250 üzeri Enterprise önerilir)',
  },
  {
    ...
    perks: [
      'Claude Team: normal 25 $/kullanıcı/ay (yıllıkta 20 $) → STK için 8 $/kullanıcı/ay',
      'Claude Team Premium: normal 125 $/ay (yıllıkta 100 $); STK indirimli fiyatı satış ekibiyle görüşülür',
      ...
      "Modele göre 200K–1M token'a kadar uzun bağlam — STK belgelerini tek istekte analiz",
  ...
  },
  {
    ...
    href: 'https://nonprofit.linkedin.com/products/all-products',
    perks: [
      'LinkedIn Recruiter Lite: nonprofit programında %50\'ye varan indirim (yıllık kontrat)',
      'Sales Navigator: %50 indirim (nonprofit sales / donor prospecting)',
      "LinkedIn Ad Grants: seçili STK'lara ücretsiz LinkedIn reklam kredisi (tutar resmi açıklanmıyor) — dönemsel başvuru (çeşitlilik/çevre/ekonomik fırsat öncelikli; duyuru: AdGrants@linkedin.com)",

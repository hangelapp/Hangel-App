...
/**
 * EventParticipants — etkinliğe katılan kurumsal/özel katılımcıları detay
 * sayfasının EN ALTINDA türe göre gruplu gösterir. corporateParticipants
 * yoksa hiçbir şey render edilmez.
 *
 * Gruplama sırası: STK'lar → Belediyeler → Valilikler → Markalar → Üniversiteler.
 * Boş gruplar atlanır. Her katılımcı: logo (yoksa monogram) + ad; website varsa
 * kart yeni sekmede o siteye link olur.
 */

import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';
import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar';
import { Building2 } from 'lucide-react';
import type { Event as EventType, CorporateParticipant, CorporateParticipantType } from '@/lib/types';
...
export function EventParticipants({ event }: { event: EventType }) {
  const participants = event.corporateParticipants;

...
export function PublicFooter({ currentPageLabel }: { currentPageLabel?: string }) {
    const footerGroups = [
        ...
        { title: "HANGEL DERNEĞİ", links: [{label: "Dernek Hakkında", href: "/hangelassociation/about"}, {label: "Dernek Etkinlikleri", href: "/hangelassociation/events"}, {label: "Uluslararası Çalıştay", href: "/hangelassociation/workshop"}, {label: "Mevzuat Taslağı", href: "/hangelassociation/legislation"}] },

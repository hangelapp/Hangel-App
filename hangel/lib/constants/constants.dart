class AppConstants {
  ...
  static String DETAIL_TEXT(String val) => "$val e-ticaret yoluyla hizmet veren bir kuruluştur.$val müşteri odaklı yaklaşımıyla 20 yılı aşkın bir süredir sizlere hizmet vermektedir. $val ürünleri kaliteli ve sağlam olmasının yanında hesaplıdır.";
}
